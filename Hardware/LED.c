...
void LED_Init(void)
{
	...
	/*设置GPIO初始化后的默认电平*/
	GPIO_SetBits(GPIOA,GPIO_Pin_8|GPIO_Pin_11);				//设置PA1和PA2引脚为高电平
}
...
void LED2_ON(void)
{
	GPIO_ResetBits(GPIOA, GPIO_Pin_11);		//设置PA2引脚为低电平
}
...
void LED2_OFF(void)
{
	GPIO_SetBits(GPIOA, GPIO_Pin_11);		//设置PA2引脚为高电平
}
...
void LED2_Turn(void)
{
	...
	{                                                  
		GPIO_SetBits(GPIOA, GPIO_Pin_11);               		//则设置PA2引脚为高电平
	}                                                  
	else                                               		//否则，即当前引脚输出高电平
	{                                                  
		GPIO_ResetBits(GPIOA, GPIO_Pin_11);             		//则设置PA2引脚为低电平
	}
}
